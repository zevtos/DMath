...
class NorthwestCornerMethodAlgorithmTest {

    @Test
    void testNorthwestCornerMethodAlgorithm() {
        ...
        NorthwestCornerMethodAlgorithm algorithm = new NorthwestCornerMethodAlgorithm(costMatrix, supply, demand);
        String result = algorithm.execute();

        assertNotNull(result);
        assertTrue(result.contains("NorthwestCornerMethod"));
        assertTrue(result.contains("Алгоритм северо-западного угла"));
    ...
    void testUnbalancedProblem() {
        ...
        double[] supply = {15.0, 25.0};
        double[] demand = {10.0, 20.0, 10.0};
